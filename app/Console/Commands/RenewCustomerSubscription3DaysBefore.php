...
class RenewCustomerSubscription3DaysBefore extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'customer_subscription:renew_3_days_before';
     ...
     * @var string
     */
    protected $description = 'Renew customer subscription before 3 days.';
    ...
    {
        $renew_date = date('Y-m-d', strtotime('+3 days'));
        ...
        foreach ($users as $key => $value) {
            ...
            if($renew == 'yes') {
                ...
                Mail::to($value->email)->send(new CustomerSubscriptionRemiderMail($value, 3));
            }
        }  
    }
}
