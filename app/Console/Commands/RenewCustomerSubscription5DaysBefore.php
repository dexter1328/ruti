...
class RenewCustomerSubscription5DaysBefore extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'customer_subscription:renew_5_days_before';
     ...
     * @var string
     */
    protected $description = 'Renew customer subscription before 5 days.';
    ...
    {
        $renew_date = date('Y-m-d', strtotime('+5 days'));
        ...
        foreach ($users as $key => $value) {
            ...
            if($renew == 'yes') {
                ...
                Mail::to($value->email)->send(new CustomerSubscriptionRemiderMail($value, 5));
            }
        }  
    }
}
