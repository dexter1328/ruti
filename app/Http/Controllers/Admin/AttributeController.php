...
class AttributeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            // 'name' => 'required|unique:attributes,name,NULL,id|max:255',
            'store_id' => 'required',
            'vendor_id' => 'required',
            'name'=> [
                'required',
        ...
        $attribute->vendor_id = $request->input('vendor_id');
        ...
        if($request->has('values')){
            foreach ($request->values as $key => $value) {
                ...
                if($value!=''){
                    ...
                    $attribute_value->vendor_id = $request->input('vendor_id');
        ...
        return redirect('/admin/attributes')->with('success',"Attribute has been saved.");
    }
    /**
    ...
    public function edit(Attribute $attribute)
    {
        ...
        return view('admin/attributes/edit',compact('attribute', 'attribute_values','vendors','vendor_stores'));
    }
    ...
    {
        $attribute->delete();
        return redirect('/admin/attributes')->with('success',"Attribute has been deleted.");
    }
