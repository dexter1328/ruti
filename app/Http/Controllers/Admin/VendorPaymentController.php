...
class VendorPaymentController extends Controller
{
    ...
    {
       $vendor_payments = VendorPayment::select('vendor_payments.amount',
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->id as $key => $value) {
            VendorPayment::where('id',$value)
                    ->update(array('status'=>'completed','paid_date'=>date("Y-m-d"),'transaction_id' => $request->transaction_id)); 
        }
        echo json_encode('Transcation Completed');
    ...
    {
        $payments = VendorPayment::select('vendor_payments.amount',
