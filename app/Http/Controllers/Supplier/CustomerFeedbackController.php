...
class CustomerFeedbackController extends Controller
{
	...
	public function index()
	{
		$customer_feedbacks = CustomerFeedback::join('vendor_stores','vendor_stores.id','=','customer_feedback.store_id')
										...
										->select('vendor_stores.name as store_name',
											...
											'users.first_name')
										->get();
		return view('supplier/customer_feedback/index',compact('customer_feedbacks'));
	}
	...
	*/
	public function create()
	{
		...
		$customers = User::all();
		return view('supplier/customer_feedback/create',compact('vendor_stores','customers'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/supplier/customer_feedback')->with('success',"Feedback Successfully Saved.");
	}
	...
	*/
	public function edit(CustomerFeedback $customer_feedback)
	{
		$vendor_stores = VendorStore::where('vendor_id',Auth::user()->id)->get();
		$customers = User::all();
		return view('supplier/customer_feedback/edit',compact('vendor_stores','customers','customer_feedback'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/supplier/customer_feedback')->with('success',"Feedback Successfully Updated.");
	}
	...
	*/
	public function destroy(CustomerFeedback $customer_feedback)
	{
		...
		return redirect('/supplier/customer_feedback')->with('success',"Feedback Successfully Deleted.");
	}
}
