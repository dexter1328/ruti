...
class CustomerRewardUsedController extends Controller
{
	...
	*/
	public function index()
	{
		$used_reward_points = CustomerRewardUsed::select(
			...
			->get();
		return view('supplier.customer_used_reward_point.index', compact('used_reward_points'));
	}
	...
	*/
	public function create()
	{
		$orders = Orders::select(
			...
			->get();
		return view('supplier.customer_used_reward_point.create', compact('orders'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/supplier/customer_used_reward_points')->with('success',"Customer used reward point has been added.");
	}
