...
class PushNotificationController extends Controller
{
	...
	*/
	public function index()
	{
		...
		$push_notifications = PushNotification::where('created_type', 'vendor')
			...
			->get();
		return view('supplier/push_notifications/index',compact('push_notifications'));
	}
	...
	*/
	...
	{
		return view('supplier/push_notifications/create');
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/supplier/push_notifications')->with('success',"Push notification successfully saved.");
	}
	...
	*/
	public function show($id)
	{
		...
		return view('supplier/push_notifications/push_notification_send', compact('push_notification','customers','vendors'));
	}
	...
	*/
	...
	{
		return view('supplier/push_notifications/edit',compact('push_notification'));
	}
	...
	*/
	public function update(Request $request, PushNotification  $push_notification)
	{
		...
		return redirect('/supplier/push_notifications')->with('success',"Push notification successfully updated.");
	}
	...
	*/
	public function destroy(PushNotification  $push_notification)
	{
		...
		return redirect('/supplier/push_notifications')->with('success',"Push notification successfully deleted.");
	}
	...
	public function send(Request $request,$id)
	{
        ...
        return redirect('supplier/push_notifications')->with('success', 'Notification has been sent.');
	}
    ...
    public function getUserNotification($id)
    {
    	$push_notifications = PushNotification::join('user_notifications','user_notifications.notification_id',
	    					...
	    					->select('push_notifications.title',
	    						...
	    						'users.last_name')
	    					->get();
		return view('supplier/push_notifications/view',compact('push_notifications'));
    }
}
