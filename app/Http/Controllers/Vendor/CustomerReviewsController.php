...
class CustomerReviewsController extends Controller
{
	...
	*/
	...
	{   
		...
		return view('vendor/customers_reviews/index',compact('customer_reviews'));
	}
	...
	*/
	public function create()
	{
		...
		$customers = User::all();
		return view('vendor/customers_reviews/create',compact('vendor_stores','customers'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/customer_reviews')->with('success',"Review Successfully Saved.");
	}
	...
	*/
	public function edit(CustomerReviews $customer_review)
	{
		$vendor_stores = VendorStore::where('vendor_id',Auth::user()->id)->get();
		$customers = User::all();
		return view('vendor/customers_reviews/edit',compact('vendor_stores','customers','customer_review'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/customer_reviews')->with('success',"Review Successfully Updated.");
	}
	...
	*/
	public function destroy(CustomerReviews $customer_review)
	{
		...
		return redirect('/vendor/customer_reviews')->with('success',"Review Successfully Deleted.");
	}
}
