...
class CustomerRewardPointController extends Controller
{
	...
	*/
	...
	public function index()
	{
		$reward_points = CustomerRewardPoint::select(
			...
			->get();
		return view('vendor.customer_reward_point.index', compact('reward_points'));
	}
	...
	*/
	public function create()
	{
		...
		return view('vendor.customer_reward_point.create', compact('users', 'reward_types'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/customer_reward_points')->with('success',"Customer reward point has been added.");
	}
	...
	*/
	public function edit(CustomerRewardPoint $customer_reward_point)
	{
		$users = User::all();
		$reward_types = RewardPoint::all();
		return view('vendor.customer_reward_point.edit', compact('customer_reward_point', 'users', 'reward_types'));
	}
	...
	*/
	public function update(Request $request, CustomerRewardPoint $customer_reward_point)
	{
		...
		return redirect('/vendor/customer_reward_points')->with('success',"Customer reward point has been updated.");
	}
	...
	*/
	public function destroy(CustomerRewardPoint $customer_reward_point)
	{
		...
		return redirect('/vendor/customer_reward_points')->with('success',"Customer reward point has been deleted.");
	}
}
