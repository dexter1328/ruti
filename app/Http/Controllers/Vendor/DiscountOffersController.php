...
class DiscountOffersController extends Controller
{
	...
	*/
	...
	public function index()
	{
		...
		$discount_offers = DiscountOffers::join('vendors','vendors.id','=',
								...
								->get();
		return view('vendor/discount_offers/index',compact('discount_offers'));
	}
	...
	*/
	...
	{	
		...
		return view('vendor/discount_offers/create',compact('vendor_stores'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/discount_offers')->with('success',"Offer has been added.");
	}
	...
	*/
	public function edit($id)
	{
		...
		return view('vendor/discount_offers/edit',compact('categories','discount_offers','products','vendor_stores'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/discount_offers')->with('success',"Offer has been updated.");
	}
	...
	*/
	public function destroy($id)
	{
		...
		DiscountOfferProduct::where('discount_id',$id)->delete();
		return redirect('/vendor/discount_offers')->with('success',"Offer has been deleted.");
	}
}
