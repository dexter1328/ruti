...
class NewsletterController extends Controller
{
	...
	*/
	...
	public function index()
	{
		...
		$vendor_paid_module = VendorPaidModule::where('module_name','newsletter')
						...
						->first();
		return view('vendor/newsletter/index',compact('newsletters','vendor_paid_module'));
	}
	...
	*/
	...
	{
		return view('vendor/newsletter/create');
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/newsletters')->with('success',"Newsletter successfully saved.");
	}
	...
	*/
	public function show($id)
	{
		...
		return view('vendor/newsletter/newsletter_send', compact('newsletter','users','vendors'));
	}
	...
	*/
	...
	{
		return view('/vendor/newsletter/edit',compact('newsletter'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/newsletters')->with('success',"Newsletter successfully updated.");
	}
	...
	*/
	public function destroy(Newsletter $newsletter)
	{
		...
		return redirect('/vendor/newsletters')->with('success',"Newsletter successfully deleted.");
	}
	...
	public function send(Request $request, $id)
	{
		...
		// die();
		return redirect('/vendor/newsletters')->with('success',"Newsletter Send");
	}
	...
	public function getUserNewsletters($id)
	{
		...
		return view('vendor/newsletter/view', compact('user_newsletters','vendor_newsletters','newsletter'));
	}
}
