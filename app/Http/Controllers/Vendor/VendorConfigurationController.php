...
class VendorConfigurationController extends Controller
{
	...
	*/
	...
	public function index()
	{
		$vendor_configurations = VendorConfiguration::join('vendors','vendors.id','=','vendor_configurations.vendor_id')
						...
						->get();
		return view('vendor/vendor_configuration/index',compact('vendor_configurations'));
	}
	...
	*/
	...
	{
		return view('vendor/vendor_configuration/create');
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/vendor_configuration')->with('success',"Configuration Successfully Saved");
	}
	...
	*/
	...
	{
		return view('vendor/vendor_configuration/edit',compact('vendor_configuration'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/vendor_configuration')->with('success',"Configuration Successfully Updated");
	}
	...
	*/
	public function destroy(VendorConfiguration $vendor_configuration)
	{
		...
		return redirect('/vendor/vendor_configuration')->with('success',"Configuration Successfully Deleted");
	}
}
