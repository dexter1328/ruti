...
class VendorCouponsController extends Controller
{
	...
	*/
	...
	{   
		...
		/*$vendor_coupans = VendorCoupons::join('vendors','vendors.id','=',
								...
								->whereIn('vendor_stores.id', $store_ids)
								->get();*/
		return view('vendor/vendor_coupons/index',compact('vendor_coupans'/*,'vendor_paid_module'*/));
	}
	...
	*/
	public function create()
	{
		...
		return view('vendor/vendor_coupons/create',compact('vendor_stores'/*,'users'*/));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/vendor_coupons')->with('success',"Coupan successfully saved.");
	}
	...
	*/
	public function edit(VendorCoupons $vendor_coupon)
	{
		...
		return view('vendor/vendor_coupons/edit',compact('vendors','vendor_stores','vendor_coupon','users','vendor_categories','discount_users'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/vendor_coupons')->with('success',"Coupan successfully updated.");
	}
	...
	*/
	public function destroy(VendorCoupons $vendor_coupon)
	{
		...
		return redirect('/vendor/vendor_coupons')->with('success',"Coupan successfully deleted.");
	}
