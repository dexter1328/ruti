...
class VendorCouponsUsedController extends Controller
{
	...
	*/
	...
	public function index()
	{
		...
		return view('vendor/vendor_coupons_used/index',compact('vendor_coupans'));
	}
	...
	*/
	public function create()
	{
		...
		return view('vendor/vendor_coupons_used/create',compact('users','vendor_coupons'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/vendor_coupons_used')->with('success',"Coupan successfully saved.");
	}
	...
	*/
	public function edit($id)
	{
		...
		return view('vendor/vendor_coupons_used/edit',compact('users','vendor_coupons','vendor_coupon_used'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/vendor_coupons_used')->with('success',"Coupan successfully updated.");
	}
	...
	*/
	public function destroy($id)
	{
        ...
        return redirect('/vendor/vendor_coupons_used')->with('success', 'Coupan is successfully deleted.');
	}
}
