...
class VendorStoreController extends Controller
{
	...
	*/
	...
	{   
		...
		return view('vendor/vendor_store/index',compact('vendor_stores'));
	}
	...
	*/
	public function create()
	{
		...
		$states = State::all();
		$cities = City::all();
		return view('vendor/vendor_store/create',compact('countries','states','cities'));
	}
	...
	*/
	public function store(Request $request)
	{
		...
		return redirect('/vendor/stores')->with('success',"Store successfully saved.");
	}
	...
	*/
	...
	{	
		...
		$countries = Country::all();
		return view('vendor/vendor_store/edit',compact('vendor_store','countries','monday','tuesday','wednesday','thursday','friday','saturday','sunday','day'));
	}
	...
	*/
	public function update(Request $request, $id)
	{
		...
		return redirect('/vendor/stores')->with('success',"Store successfully updated.");
	}
	...
	*/
	public function destroy($id)
	{
		$vendor_store = VendorStore::findOrFail($id);
		$vendor_store->delete();
		return redirect('/vendor/stores')->with('success',"Store successfully deleted.");
	}
	...
	public function importStore(Request $request)
	{
		...
		if(strtolower($extension) == 'csv') {
	        ...
	        Helper::addToLog('Import Store',Auth::user()->id);
	       	return redirect('/vendor/stores')->with('success-data', array('emails' => $exists_emails, 'message' => 'Store successfully imported.') );
	    }else{
	    	return redirect('/vendor/stores')->with('error-data','The import file must be a file of type: csv.');
