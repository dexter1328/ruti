	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-picture-o"></i> --><span>Add Banner</span></div>
			</div>
			<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<select name="position" class="form-control">
								...
								<option value="Top" @if(old('position')=='Top') selected="selected" @endif>Top</option>
								<option value="Bottom" @if(old('position')=='Bottom') selected="selected" @endif>Bottom</option>
							</select>
