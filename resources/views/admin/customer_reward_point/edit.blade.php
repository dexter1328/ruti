	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-trophy"></i> --><span>Edit Customer Reward Point</span></div>
			</div>
			<div class="card-body">
				@if ($errors->any())
				...
				@endif
				<form id="signupForm" method="post" action="{{route('customer_reward_points.update',$customer_reward_point->id)}}" enctype="multipart/form-data">
					@csrf
					@method('PATCH')
					...
					<center>
						<div class="form-footer">
							...
							<a href="{{url('admin/customer_reward_points')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>
						</div>
					</center>
				</form>
			</div>
