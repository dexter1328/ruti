	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left">
					<!-- <i class="fa fa-trophy"></i> --><span>Add Customer Used Reward Point</span>
				</div>
			</div>
			<div class="card-body">
            	<div class="container-fluid">
					<form id="signupForm" method="post" action="{{route('customer_used_reward_points.store')}}" enctype="multipart/form-data">
					@csrf
					...
					<center>
						<div class="form-footer">
							...
							<a href="{{url('admin/customer_used_reward_points')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>
						</div>
					</center>
					</form>
                </div>
