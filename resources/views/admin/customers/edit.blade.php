		...
		<div class="card">
			...
			<div class="card-body">
            	<div class="container-fluid">
					<form id="signupForm" method="post" action="{{ route('customer.update',$customer->id) }}" enctype="multipart/form-data">
						@csrf
						@method('PATCH')
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="autoclose-datepicker" name="dob" placeholder="Enter DOB" value="{{old('dob',date('m/d/Y', strtotime($customer->dob)))}}">
								@if ($errors->has('dob'))
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="autoclose-datepicker1" name="anniversary_date" placeholder="Enter Anniversary Date" value="@if($customer->anniversary_date){{old('anniversary_date',date('m/d/Y', strtotime($customer->anniversary_date)))}}@endif">
