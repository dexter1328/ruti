    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="left"><!-- <i class="fa fa-percent"></i> --><span>Edit Offers</span></div>
            </div>
            <div class="card-body">
            	<div class="container-fluid">
	                <form id="signupForm" method="post" action="{{route('discount_offers.update', $discount_offers->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <select name="vendor" class="form-control" id="vendor">
                                                        ...
                                                        @php $selected = ($vendor->id == old('vendor',$discount_offers->vendor_id)) ? 'selected="selected"' : ''; @endphp
...
<script>
   ...
   $(document).ready(function() {
        ...
        vendor_id = '{{$discount_offers->vendor_id}}';
        getStore(vendor_id, '{{$discount_offers->store_id}}');

        store_id = '{{$discount_offers->store_id}}';
        // product_id ='{{$discount_offers->product_id}}';
