	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-newspaper-o"></i> --><span>Add Newsletter</span></div>
			</div>
			<div class="card-body">
            	<div class="container-fluid">
					<form id="signupForm" method="post" action="{{ route('newsletters.store') }}" enctype="multipart/form-data">
					@csrf
