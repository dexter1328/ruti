	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-newspaper-o"></i> --><span>Send Newsletter</span></div>
			</div>
			<div class="card-body">
				<form id="signupForm" method="post" action="{{ url('/admin/newsletters/send', $newsletter->id) }}" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group row" id="subscribers">
						<label for="input-13" class="col-sm-2 col-form-label">Subscribers<span class="text-danger">*</span></label>
						<div class="col-sm-10">
							<select name="subscribers[]" class="form-control" multiple="multiple" id="subscribers_id">
