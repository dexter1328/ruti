	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left">
					<!-- <i class="fa fa-bell"></i> --><span>Edit Push Notification</span>
				</div>
			</div>
			<div class="card-body">
				<div class="container-fluid">
					<form id="signupForm" method="post" action="{{ route('push_notifications.update',$push_notification->id) }}" enctype="multipart/form-data">
						@csrf
						@method('PATCH')
