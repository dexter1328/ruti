    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="left"><!-- <i class="fa fa-edit"></i> --><span>Add New Role</span></div>
            </div>
            <div class="card-body">
            	<div class="container-fluid">
	                <form id="personal-info" method="post" action="{{ route('admin_roles.store') }}">
                    @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="icheck-material-primary">
                                                <input type="checkbox" class="read_chk" id="read-{{$key}}" name="permision[{{$key}}][read]" value="yes" @if(isset(old('permision')[$key]['read'])) checked="checked" @endif> 
