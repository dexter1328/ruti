        ...
        <div class="card">
            ...
            <div class="card-body">
            	...
            	<div class="container-fluid">
	                <form id="signupForm" method="post" action="{{route('vendor_coupons.store')}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control start_date" id="autoclose-datepicker" name="start_date" placeholder="Enter Start Date" value="{{old('start_date')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control end_date" id="autoclose-datepicker1" name="end_date" placeholder="Enter End Date" value="{{old('end_date')}}">
