	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-tags"></i> --><span>Vendor Unverified Coupons</span></div>
								...
								<tr>
									...
									<td class="action">
										<form id="deletefrm_{{$vendor_coupan->id}}" action="{{ route('vendor_coupons.destroy', $vendor_coupan->id) }}" method="POST" class="delete"  onsubmit="return confirm('Are you sure?');">
											@csrf
											@method('DELETE')
											<a href="{{ url('admin/vendor_coupons/unverified_edit') }}/{{$vendor_coupan->id}}" class="edit" data-toggle="tooltip" data-placement="bottom" title="Edit Coupon">
											...
											<a href="{{ url('admin/vendor_coupons/verified') }}/{{$vendor_coupan->id}}" class="edit" data-toggle="tooltip" data-placement="bottom" title="Verify Coupon" style="margin-left: 5px;">
												<i class="fa fa-check"></i>
											</a>
