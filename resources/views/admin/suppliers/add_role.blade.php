	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-users"></i> --><span>Supplier Roles</span></div>
	                    ...
	                    <table id="example" class="table table-bordered">
	                        ...
	                        <tbody>
	                            ...
	                            <tr>
	                                ...
	                                <td class="action">
	                                    <form id="deletefrm_{{$vendor_role->id}}" action="{{ url('admin/supplier/delete_role', $vendor_role->id) }}" class="delete" method="GET" onsubmit="return confirm('Are you sure?');">
	                                        <!-- @csrf -->
	                                        <!-- @method('DELETE') -->
	                                        <!-- <a href="{{ url('admin/supplier/edit_role', $vendor_role->id) }}" class="edit">
					...
					<div class="modal-dialog" style="width:53%;">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form method="post" action="{{ url('admin/supplier/supplier_add_role',$id) }}" enctype="multipart/form-data">
									@csrf
				...
				<div id="editmyModal" class="modal fade" role="dialog">
					<div class="modal-dialog" style="width:53%;">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="signupForm" method="post" action="{{ url('admin/supplier/update_role') }}" enctype="multipart/form-data">
									@csrf
									<div class="form-group row">
										<label for="input-12" class="col-sm-2 col-form-label">Role Name<span class="text-danger">*</span></label>
										<div class="col-sm-10">
...
<script type="text/javascript">
	...
	function editRole(id){
		$.ajax({
			url: "{{ url('admin/supplier/edit_role') }}/"+id,
			type: "GET",
			dataType: 'json',
