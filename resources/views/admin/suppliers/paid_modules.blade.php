		...
		<div class="card">
			<div class="card-header">
				...
				<div class="float-sm-right">
					<a style="padding-bottom: 3px; padding-top: 4px;" href="{{ url('admin/supplier/paid_modules/create') }}/{{$id}}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1" title="Add Admin">
			...
			<div class="card-body">
						...
						<tbody>
							@foreach($paid_modules as $key=>$paid_module)
								<tr>
									...
									<td>
										<a href="{{ url('admin/supplier/paid_modules/edit') }}/{{$paid_module->id}}" class="edit" data-toggle="tooltip" data-placement="bottom" title="Edit Paid Modules">
            	...
            	<div class="container-fluid">
					<!-- <form id="signupForm" method="post" action="{{ url('admin/supplier/paid_modules',$id) }}" enctype="multipart/form-data">
					@csrf
