	...
	<div class="col-lg-12">
		<div class="card">
			<div class="card-header">
				<div class="left"><!-- <i class="fa fa-tags"></i> --><span>Vendor Coupons</span></div>
				<div class="float-sm-right">        
					<a style="padding-bottom: 3px; padding-top: 4px;" href="{{ route('vendor_coupons.create') }}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1" title="Add Coupon">
						...
						<tbody>
							@foreach($vendor_coupans as $key=> $vendor_coupan)
								<tr>
                                	...
                                	@endif
									<td class="action">
										<form id="deletefrm_{{$vendor_coupan->id}}" action="{{ route('vendor_coupons.destroy', $vendor_coupan->id) }}" method="POST" class="delete"  onsubmit="return confirm('Are you sure?');">
											@csrf
											@method('DELETE')
											<a href="{{ route('vendor_coupons.edit', $vendor_coupan->id) }}" class="edit" data-toggle="tooltip" data-placement="bottom" title="Edit Coupon">
