		...
		<div class="card">
			...
			<div class="card-body">
            	<div class="container-fluid">
					<form id="signupForm" method="post" action="{{ route('vendor_store.update',$vendor_store->id) }}" enctype="multipart/form-data">
					@csrf
					@method('PATCH')
					...
					<center>
						<div class="form-footer">
							...
							<a href="{{url('admin/vendor_store')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>
						</div>
					</center>
				</form>
                </div>
