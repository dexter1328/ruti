		...
		<div class="card">
			...
			<div class="card-body">
            	<div class="container-fluid">
					<form id="signupForm" method="post" action="{{ route('vendor.update',$vendor->id) }}" enctype="multipart/form-data">
						@csrf
						@method('PATCH')
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								...
								value="{{old('expired_date',date('m/d/Y', strtotime($vendor->expired_date)))}}">
							</div>	
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" name="admin_commision" class="form-control" value="{{old('admin_commision',$vendor->admin_commision)}}">
							</div>
						</div>
						<div class="form-group row">
