            ...
            <div class="row align-items-center">
                <div class="col-md-10 col-offset-md-1">
                    <div class="font-para">
                        ...
                        @else
                            <p>RUTI self checkout intends to fully comply with the Digital Millennium Copyright Act ("DMCA"), including the notice and "take down" provisions, and to benefit from the safe harbors immunizing RUTI self checkout from liability to the fullest extent of the law. RUTI self checkout reserves the right to terminate the account of any Member who infringes upon the copyright rights of others upon receipt of proper notification by the copyright owner or the copyright owner's legal agent.</p>
                            <p>Included below are the processes and procedures that RUTI self checkout will follow to resolve any claims of intellectual property violations:</p>
                        @endif
                        <div id="accordion">     
                            @php $result = [];
                            ...
                            @else
                                <div class="card">
                                    ...
                                    <div id="collapse1" class="collapse show" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>If you believe that your work has been copied in a way that constitutes copyright infringement, or that your intellectual property rights have been otherwise violated, please provide RUTI self checkout's Copyright Agent with the following information:</p>
                                            <ul class="bullet">
                                            ...
                                            <p>RUTI self checkout's Copyright Agent for Notice for Claims of Intellectual Property Violations can be reached as follows: E-Mail: info@EzSiop.comand subject line: ABUSE</p>
                                            ...
                                            <p>Upon RUTI self checkout's receipt of a Notice for Claims of Intellectual Property Violations, RUTI self checkout will take the following steps:</p>
                                            <ul class="bullet">
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapse2" class="collapse" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>If a Member receives notice that a material or activity posted on the Site was removed or disabled and the Member wishes to dispute the Notice for Claims of Intellectual Property Violations, the Member must provide RUTI self checkout's Copyright Agent with the following information:</p>
                                            <ul class="bullet">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <a class="collapsed card-link" data-toggle="collapse" href="#collapse3"><i class="fa fa-plus"></i>RUTI self checkout's Response upon Receipt of a Counter Notification Form.</a>
                                    </div>
                                    <div id="collapse3" class="collapse" data-parent="#accordion">
                                        <div class="card-body">
                                            <p>Upon RUTI self checkout's receipt of a Counter Notification Form, RUTI self checkout will take the following steps:</p>
                                            <ul class="bullet">
                                                <li>Promptly provide the Complainant with a copy of the Counter Notification Form;</li>
                                                <li>Promptly inform the Complainant that the removed or disabled material or activity will be replaced or re-enabled in not less than ten (10), but no more than fourteen (14), business days unless RUTI self checkout's Copyright Agent first receives notice that the Complainant has filed an action seeking a court order to restrain the Member from engaging in infringing activity relating to the material or activity on the Site; and</li>
                                                <li>After the period in Section (D)(2) above has elapsed, replace or re-enable the disabled material unless a notice of action as defined in Section (D)(2) above has been received (unless the material is determined by RUTI self checkout in its sole discretion to potentially infringe any intellectual property rights).</li>
                                            </ul>
