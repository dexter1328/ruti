...
<head>
    ...
    <meta property="og:description"
          content="We provide convenient and expeditious service to all users (merchants and consumers) in areas of consumer spending. Our service is to improve merchant - customer relations while offering positive contribution to the overall economy."/>
    ...
    @if(request()->is('vendor-signup'))
        ...
        <script> window.dataLayer = window.dataLayer || [];
            ...
            gtag('js', new Date());
            gtag('config', 'AW-978318545'); </script>
    @endif
                                    ...
                                    <div class="header-action">
                                        <ul>
                                                    ...
                                                    <div class="dropdown-menu login-dropdown" aria-labelledby="dropdownMenuLink">
                                                        <form class="px-4 py-3" method="POST" action="{{ url('/w2bcustomer/login') }}">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="email" class="form-control {{ $errors->has('email') ? 'error' : '' }}" name="email" id="exampleDropdownFormEmail1"
                                            ...
                                            <li class="header-shop header_wishlist">
                                                @if (Auth::guard('w2bcustomer')->user()) <a href="{{route('wb-wishlist-page')}}"> @else <a href="#" type="button" data-toggle="modal" data-target="#exampleModal28"> @endif
                                                    <i class="lnr lnr-heart fa-3x"></i>
                                                    <!--Wishlist-->
                                                    <span class="cart-count">{{ !empty($wb_wishlist) ? $wb_wishlist->count() : 0 }}</span>
                                                </a>
                                            </li>
                                                            ...
                                                            @foreach(session('cart') as $sku => $details)
                                                                <div class="cart_item" style="padding: 5px 0px;">
                                                                    ...
                                                                    <div class="cart_info">
                                                                        ...
                                                                        <p style="font-size: 15px">{{ $details['quantity'] }} x
                                                                            <span> ${{number_format((float)$details['retail_price'], 2, '.', '')}} </span></p>
                                                                    </div>
