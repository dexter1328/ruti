            ...
            <div class="row align-items-center">
                <div class="col-md-10 col-offset-md-1">
                    <div class="font-para about-left">
                        ...
                        <br>
                        <h3 style="text-align: center; color: green">One-time fee of $339 gets you started today.</h3>
                        <br>
                        <h5 style="text-align: center;">Cost of service only $3.30 per day thereafter.</h5>
                        <p>Register or give us a call <a href="tell:1.888.802.6036">1.888.802.6036</a></p>
                        <p>Direct phone number: <a href="tell:1.209.340.9403">1.209.340.9403</a></p>
                        <p>
                            <a href="{{url('/supplier/signup')}}" class="btn btn-success">Register Now</a>
                        </p>
                    </div>
                </div>
            </div>
