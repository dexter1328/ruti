...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="editFrm" method="post" action="{{route('supplier.attributes.update', $attribute->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <center>
                        ...
                        <a href="{{url('supplier/attributes')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>
                    </center>
                </form>
            </div>
        </div>
