...
<div class="card-body">
    <div class="card-content p-2">
       ...
       <!--  @if (session('status'))
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/supplier/password/email') }}">
            {{ csrf_field() }}
...
<div class="card-footer text-center py-3">
    <p class="text-dark mb-0">Return to the <a href="{{ route('supplier.login') }}"> Sign In</a></p>
</div>
@endsection
