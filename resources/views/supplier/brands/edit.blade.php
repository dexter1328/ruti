...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<form id="signupForm" method="post" action="{{route('supplier.brand.update',$brand->id)}}" enctype="multipart/form-data">
					@csrf
					@method('PATCH')
					...
					<center>
						<div class="form-footer">
							...
							<a href="{{url('supplier/brand')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>
						</div>
					</center>
				</form>
			</div>
