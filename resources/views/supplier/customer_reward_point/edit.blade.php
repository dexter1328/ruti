	...
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				...
				@endif
				<form id="signupForm" method="post" action="{{route('supplier.customer_reward_points.update',$customer_reward_point->id)}}" enctype="multipart/form-data">
					@csrf
					@method('PATCH')
					...
					<center>
						<div class="form-footer">
							...
							<a href="{{url('supplier/customer_reward_points')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>
						</div>
					</center>
				</form>
			</div>
