		...
		<div class="card">
			<div class="card-header">
				...
				<div class="float-sm-right">
					<a style="padding-bottom: 3px; padding-top: 4px;" href="{{ route('supplier.customer_reward_points.create') }}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1" title="Add Reward Point">
						...
						<tbody>
							@foreach($reward_points as $key=> $reward_point)
								<tr>
									...
									@php /* @endphp
									<td class="action">
										<form id="deletefrm_{{$reward_point->id}}" action="{{ route('supplier.customer_reward_points.destroy', $reward_point->id) }}" method="POST" class="delete"  onsubmit="return confirm('Are you sure?');">
										@csrf
											@method('DELETE')
											<a href="{{ route('supplier.customer_reward_points.edit', $reward_point->id) }}" class="edit">
