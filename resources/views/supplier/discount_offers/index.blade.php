		...
		<div class="card">
			<div class="card-header">
				...
				<div class="float-sm-right">
					...
					href="{{ route('supplier.discount_offers.create') }}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1" title="Add Offer">
						...
						<tbody>
							@foreach($discount_offers as $key => $discount_offer)
								...
								<!-- 	<td>{{$discount_offer->title}}</td> -->
									...
									<td class="action">
									<form id="deletefrm_{{$discount_offer->id}}" action="{{ route('supplier.discount_offers.destroy', $discount_offer->id) }}" method="POST" class="delete"  onsubmit="return confirm('Are you sure?');">
									@csrf
									@method('DELETE')
									<a href="{{ route('supplier.discount_offers.edit', $discount_offer->id) }}" class="edit">
