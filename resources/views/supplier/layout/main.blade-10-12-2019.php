            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li class="{{ (request()->is('admin/admins') or request()->is('admin/admins/create') or request()->is('admin/admin_roles') or request()->is('admin/admin_roles/create')) ? 'active menu-open' : '' }}">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="{{ (request()->is('supplier/suppliers') or request()->is('supplier/suppliers/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/suppliers')}}">
                                <i class="fa fa-user"></i> All Vendors
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/supplier_roles') or request()->is('supplier/supplier_roles/create')) ? 'active' : '' }}">
                ...
                <li class="{{ (request()->is('supplier/supplier/create') or request()->is('supplier/stores/create') or request()->is('supplier/supplier_configuration/create') or request()->is('supplier/supplier_coupons/create') or request()->is('supplier/supplier_coupons_used/create')) ? 'active menu-open' : '' }}">
                    <a href="javaScript:void();" class="waves-effect">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="{{ (request()->is('supplier/stores') or request()->is('supplier/stores/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/stores')}}" class="waves-effect">
                                <i class="fa fa-shopping-bag" style="font-size: 12px;"></i>
                                <span>Manage Store</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/supplier_configuration') or request()->is('supplier/supplier_configuration/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/supplier_configuration')}}" class="waves-effect">
                                <i class="fa fa-cog"></i>
                                <span>Manage Configuration</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/supplier_coupons') or request()->is('supplier/supplier_coupons/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/supplier_coupons')}}" class="waves-effect">
                                <i class="fa fa-file"></i>
                                <span>Manage Coupons</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/supplier_coupons_used') or request()->is('supplier/supplier_coupons_used/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/supplier_coupons_used')}}" class="waves-effect">
                                <i class="fa fa-file"></i>
                ...
                <li class="{{ (request()->is('supplier/brand/create') or request()->is('supplier/products/create') or request()->is('supplier/suppliers_category/create') or request()->is('supplier/attributes/*')) ? 'active menu-open' : '' }}">
                    <a href="javaScript:void();" class="waves-effect">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="{{ (request()->is('supplier/products') or request()->is('supplier/products/create')) ? 'active' : '' }}">
                        ...
                        <li class="{{ (request()->is('supplier/product_reviews') or request()->is('supplier/product_reviews/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/product_reviews')}}" class="waves-effect">
                                <i class="fa fa-star"></i>
                                <span>Manage Reviews</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/categories') or request()->is('supplier/categories/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/categories')}}" class="waves-effect">
                                <i class="fa fa-minus-square"></i>
                                <span>Manage Category</span>
                            </a>
                        </li>
                        <li class="{{ request()->is('supplier/attributes/*') ? 'active' : '' }}">
                            <a href="{{url('supplier/attributes')}}" class="waves-effect">
                                <i class="fa fa-list"></i>
                                <span>Manage Attributes</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/brand') or request()->is('supplier/brand/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/brand')}}" class="waves-effect">
                                <i class="fa fa-glide-g"></i>
                                <span>Manage Brands</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/discount_offers') or request()->is('supplier/discount_offers/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/discount_offers')}}" class="waves-effect">
                                <i class="fa fa-glide-g"></i>
                ...
                <li class="{{ (request()->is('supplier/customer/create') or request()->is('supplier/customer_feedback/create') or request()->is('supplier/customer_reviews/create') or request()->is('supplier/customer_reward_point/create')) ? 'active menu-open' : '' }}">
                    <a href="javaScript:void();" class="waves-effect">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="{{ (request()->is('supplier/customer') or request()->is('supplier/customer/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/customer')}}" class="waves-effect">
                                <i class="fa fa-user"></i>
                                <span>Manage Customers</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/customer_feedback') or request()->is('supplier/customer_feedback/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/customer_feedback')}}" class="waves-effect">
                                <i class="fa fa-building-o"></i>
                                <span>Manage Feedback</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/customer_reviews') or request()->is('supplier/customer_reviews/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/customer_reviews')}}" class="waves-effect">
                                <i class="fa fa-building-o"></i>
                                <span>Manage Reviews</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/customer_reward_point') or request()->is('supplier/customer_reward_point/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/customer_reward_point')}}" class="waves-effect">
                                <i class="fa fa-inr"></i>
                ...
                <li class="{{ (request()->is('supplier/orders/create') or request()->is('supplier/order_items/create') or request()->is('supplier/order_return/create') or request()->is('supplier/cancelled_orders/create')) ? 'active menu-open' : '' }}">
                    <a href="javaScript:void();" class="waves-effect">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="{{ (request()->is('supplier/orders') or request()->is('supplier/orders/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/orders')}}" class="waves-effect">
                                <i class="fa fa-shopping-bag"></i>
                                <span>Manage Orders</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/order_return') or request()->is('supplier/order_return/create')) ? 'active' : '' }}">
                            <a href="{{url('supplier/order_return')}}" class="waves-effect">
                                <i class="fa fa-file-text-o"></i>
                                <span>Manage Orders Return</span>
                            </a>
                        </li>
                        <li class="{{ (request()->is('supplier/cancelled_orders') or request()->is('supplier/cancelled_orders/create')) ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown-lg">
                     ...
                     <li class="nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li class="dropdown-divider"></li>
                            <li class="dropdown-item">
                                <a href="{{ url('/supplier/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
