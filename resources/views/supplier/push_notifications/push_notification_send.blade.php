...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<form id="signupForm" method="post" action="{{ url('/supplier/push_notifications/send', $push_notification->id) }}" enctype="multipart/form-data">
					@csrf
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<select name="user_type" class="form-control" id="user_type">
								...
								<option value="vendor" @if(old('user_type') == 'vendor') selected="selected" @endif>Supplier</option>
							</select>
					...
					<div class="form-group row" id="vendor" style="display: none;">
						<label for="input-13" class="col-sm-2 col-form-label">Supplier<span class="text-danger">*</span></label>
						<div class="col-sm-10">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
    	...
    	$('#vendor_id').multiselect({
			allSelectedText: 'All',
      		includeSelectAllOption: true,
	        nonSelectedText: 'Select Supplier',
	        buttonWidth: '100%',
	        maxHeight: 500,
	        maxWidth: 500,
    	});
