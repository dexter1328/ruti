...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('supplier.supplier_roles.update', $supplier_role->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <!-- <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" id="status" name="status">
                                ...
                                <option value="active" @if(old('status')) @if(old('status')=='active') selected="selected" @endif @else @if($supplier_role->status=='active') selected="selected" @endif @endif>Active</option>
                                <option value="deactive" @if(old('status')) @if(old('status')=='deactive') selected="selected" @endif @else @if($supplier_role->status=='deactive') selected="selected" @endif @endif>Deactive</option>
                            </select>
