            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="cardListDiv">
                        ...
                        <form action="{{route('supplier.ruti-fullfill-payment')}}" method="post">
                            @csrf
                        ...
                        <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary mt-2 px-5" >Pay Now!</button>
                        </form>
                            ...
                            if ($.isEmptyObject(pending_subscription)) {
                                ...
                                $('.btnSbscrtnFrm').each(function() {
                                    ...
                                    if ($.isEmptyObject(current_subscription)) {
                                        ...
                                        } else if (current_membership_code == 'blossom' &&
                                            membership_code == 'sprout') {
                                            $(this).attr('onclick',
                                                'alert("You can cancel your plan but can\'t downgrade.")'
                                                );
