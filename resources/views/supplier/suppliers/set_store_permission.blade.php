...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="signupForm" method="post" action="{{ url('/supplier/suppliers/set-store-permission') }}/{{$id}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <center>
                        <div class="form-footer">
                            ...
                            @else
                               ...
                               <!--  <a href="{{url('supplier/suppliers')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> Delete</button></a> -->
                            @endif
                        </div>
                    </center>
                </form>
