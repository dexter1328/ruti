    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="left"><!-- <i class="fa fa-user"></i> --> <span>Supplier Transactions</span></div>
                        ...
                        <table id="example" class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Supplier <br>Contact <br>Person</th>
                                    <th>Supplier <br>Address</th>
                            ...
                            <tbody>
                                @foreach($orders as $key => $order)
                                    <tr>
                                        <!-- <td>{{$key+1}}</td> -->
                                        <td>@if($order->image == '')<img src="{{asset('public/images/deafult.jpg')}}" height="75" width="75">@else<img src="{{asset('public/images/suppliers/'.$order->image)}}" height="75" width="75">@endif</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th>Image</th>
                                    <th>Supplier <br>Name</th>
                                    <th>Supplier <br>Contact Person</th>
                                    <th>Supplier <br>Address</th>
 ...
 $(document).ready(function() {
    ...
    var table = $('#example').DataTable( {
        ...
        buttons: [
            {
                extend: 'copy',
                title: 'Supplier Transactions List',
                exportOptions: {
