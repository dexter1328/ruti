		...
		<div class="card">
			<div class="card-header">
				...
				<div class="float-sm-right">        
					<a style="padding-bottom: 3px; padding-top: 4px;" href="{{ route('vendor.brand.create') }}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1" title="Add Brand">
						...
						<tbody>
							@foreach($brands as $key=> $brand)
								<tr>
									...
									<td class="action">
										<form id="deletefrm_{{$brand->id}}" action="{{ route('vendor.brand.destroy', $brand->id) }}" method="POST" class="delete"  onsubmit="return confirm('Are you sure?');">
											@csrf
											@method('DELETE')
											<a href="{{ route('vendor.brand.edit', $brand->id) }}" class="edit" data-toggle="tooltip" data-placement="bottom" title="Edit Brand">
