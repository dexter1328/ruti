		...
		<div class="card">
			...
			<div class="card-body">
            	<div class="container-fluid">
					<form id="signupForm" method="post" action="{{route('vendor.customer_used_reward_points.store')}}" enctype="multipart/form-data">
					@csrf
					...
					<center>
						<div class="form-footer">
							...
							<a href="{{url('vendor/customer_used_reward_points')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a> 
						</div>
					</center>
					</form>
                </div>
