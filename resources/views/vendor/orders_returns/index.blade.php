                    ...
                    <tbody>
                        @foreach($return_orders as $key =>$return_order)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('vendor.orders.show-return', ['order_no' => $return_order->order_no, 'sku' => $return_order->product_sku]) }}" class="edit" data-toggle="tooltip" data-placement="bottom" title="View ReturnOrder">
