...
function getProduct(){
	...
	$('#example').removeAttr('width').DataTable({
		...
		"serverSide": true,
		"ajax":{
			"url": "{{ url('vendor/products/get-inventory') }}",
			"dataType": "json",
			"type": "POST",
...
function updateQuatity(id)
{
	...
	$.ajax({
		type: "post",
		url: "{{ url('vendor/products/update-quantity') }}",
		headers: {
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
		},
...
function updateDiscount(id)
{
	...
	$.ajax({
		type: "post",
		url: "{{ url('vendor/products/update-discount') }}",
		headers: {
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
		},
...
function updatePrice(id)
{
	...
	$.ajax({
		type: "post",
		url: "{{ url('vendor/products/update-price') }}",
		headers: {
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
		},
