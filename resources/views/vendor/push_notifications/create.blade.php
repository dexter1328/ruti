    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="left"><span>Add Push Notification</span></div>
            </div>
            <div class="card-body">
                <div class="container-fluid">
                    <form id="signupForm" method="post" action="{{ route('vendor.push_notifications.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <center>
                            <div class="form-footer">
                                ...
                                <a href="{{url('vendor/push_notifications')}}"><button type="button" class="btn btn-danger"><i class="fa fa-times"></i> CANCEL</button></a>  
                            </div>
                        </center>
                    </form>
                </div>
