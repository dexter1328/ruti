                        ...
                        <table id="default-datatable" class="table table-bordered">
                                    ...
                                    <th>Read
                                        <div class="checkbox-th table-right-tick">
                                            <span class="bmd-form-group is-filled">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" class="chkallreadmobile">
                                                    </label>
                                                </div>
                                            </span>
                                        </div>
                                    ...
                                    <th>Write
                                        <div class="checkbox-th table-right-tick">
                                            <span class="bmd-form-group is-filled">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" class="chkallwritemobile">
                                                    </label>
                                                </div>
                                            </span>
                                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <div class="icheck-material-primary">
                                            <input type="checkbox" id="readmobile-{{$key}}" class="readchkmobile" name="permision[{{$key}}][read]" value="yes" @if(isset($permisions[$key]['read']) && $permisions[$key]['read'] == 'yes') checked="checked" @endif> 
                                            <label for="readmobile-{{$key}}"></label>
                                        </div>
                                    </td>
                                    <td align="center">
                                        <div class="icheck-material-primary">
                                            <input type="checkbox" id="writemobile-{{$key}}" class="writechkmobile" name="permision[{{$key}}][write]" value="yes" @if(isset($permisions[$key]['write']) && $permisions[$key]['write'] == 'yes') checked="checked" @endif> 
                                            <label for="writemobile-{{$key}}"></label>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
...
<script>
    $(document).ready(function(){
        ...
        $('.readchkmobile').each(function() {
            if ($(this).prop("checked") == false){
                flag1_mobile = false;
            }
        });
        $('.chkallreadmobile').prop('checked', flag1);

        var flag2_mobile = true;
        $('.writechkmobile').each(function() {
            if ($(this).prop("checked") == false){
                flag2_mobile = false;
            }
        });
        $('.chkallwritemobile').prop('checked', flag2);
    });
</script>
@endif
<script>
    $(document).ready(function(){
        ...
        // mobile module
        $('.chkallreadmobile').on('click', function() { 
            if($(this).prop("checked") == false && $('.chkallwritemobile').prop("checked") == true){
                $(this).prop('checked', true); 
                $('.writechkmobile').each(function() {
                    var id_arr = $(this).attr('id').split('-');
                    $('#readmobile-'+id_arr[1]).prop("checked", $(this).prop("checked"));
                });
            }else if($(this).prop("checked") == false && $('.chkallwritemobile').prop("checked") == false){
                $('.writechkmobile').each(function() {
                    var id_arr = $(this).attr('id').split('-');
                    $('#readmobile-'+id_arr[1]).prop("checked", $(this).prop("checked"));
                });
            }else{
                $('.readchkmobile').prop('checked', $(this).prop("checked"));  
            } 
        });

        $('.readchkmobile').on('click', function() {

            var id_arr = $(this).attr('id').split('-');
            if($(this).prop("checked") == false && $('.chkallreadmobile').prop("checked") == true && $('#writemobile-'+id_arr[1]).prop("checked") == false){
                $('.chkallreadmobile').prop('checked', $(this).prop("checked")); 
            }else if($(this).prop("checked") == false && $('.chkallreadmobile').prop("checked") == false && $('#writemobile-'+id_arr[1]).prop("checked") == false){
                $(this).prop('checked', false); 
            }else{
                $(this).prop('checked', true); 
            }
            ...
            $('.chkallreadmobile').prop('checked', flag);
        });

        $('.chkallwritemobile').on('click', function() {     
            $('.writechkmobile').prop('checked', $(this).prop("checked")); 
        ...
        $('.writechkmobile').on('click', function() {

            var id_arr = $(this).attr('id').split('-');
            if($('#readmobile-'+id_arr[1]).prop("checked") == false){
                $('#readmobile-'+id_arr[1]).prop('checked', $(this).prop("checked"));
            }

            if($(this).prop("checked") == false && $('.chkallwritemobile').prop("checked") == true){
                $('.chkallwritemobile').prop('checked', $(this).prop("checked")); 
            }
