						...
						<div class="vendor-btn-right"> 
		                	<div class="row">   
		                		<div class="col-xs-12 col-sm-3">
		                			<a href="{{url('/public/ezsiop-employee-import.csv')}}" download="sample-employee.csv" class="download-csv">Download Sample CSV</a>
		                		</div>
		                      	<div class="col-xs-12 col-sm-3">
		                        ...
		                        <div class="col-xs-12 col-sm-3">
		                      		<a href="{{ url('vendor/vendors/export/vendor') }}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1"><span class="name">Export</span></a>
		                        </div>
		                        <div class="col-xs-12 col-sm-3">
		                        	<a href="{{ route('vendors.create') }}" class="btn btn-outline-primary btn-sm waves-effect waves-light m-1" title="Add Employee">
...
<div class="modal fade" id="importModal">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div id="error"></div>
				<form method="post" action="{{ url('vendor/vendors/import-vendor') }}" enctype="multipart/form-data">
					@csrf
...
$(document).ready(function() {
	...
	$("#btnPreview").click(function(){
		...
		if($('#import_file').val() != ''){
			...
			$.ajax({
				url: "{{ url('/vendor/vendors/get_vendor_import_preview') }}",
				type: 'post',
				headers: {
	...
	var table = $('#example').DataTable({
        ...
        "lengthChange": false,
        "ajax":{
			"url": "{{ url('vendor/vendors/view/vendor_datatable') }}",
			"dataType": "json",
			"type": "POST",
