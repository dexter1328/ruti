...
<div class="card-body">
    <div class="card-content p-2">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/vendor/submit-otp/'.$vendor_otp->token) }}">
            {{ csrf_field() }}
    ...
    $( document ).ready(function() {
        $("#resend_otp").click(function(){
            $.ajax({
                ...
                url: "{{ url('/vendor/resend_otp_mail') }}",
                headers: {
                ...
                success: function (data) {
                    ...
                    //$(".error").html('');
                    window.location.replace("{{ url('vendor/submit-otp/'.$vendor_otp->token) }}");
                }
            });
        });
    });
